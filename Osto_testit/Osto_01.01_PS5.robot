...
Tuotehaku
    ...
    #Sign in
    Input text to field     query       Playstation 5
    Valitse elementti     submit
#    Sleep     3s
...
#    Sleep    2s
#    Click element       css:#app > main > div > div > div.vk-pages > div.vk-pages-sticky_footer > div > a.vk-pointy-button.vk-pointy-button--right.vk-pointy-button--primary.vk-pointy-button--next-step
#    Odota otsaketta     Valitse maksutapa
...
##    Sleep    2s
##    Click element       css:#app > main > div > div > div.vk-pages > div.vk-pages-sticky_footer > div > a.vk-pointy-button.vk-pointy-button--right.vk-pointy-button--primary.vk-pointy-button--next-step
##    Odota otsaketta     Vahvista tilauksesi tiedot
#
#Poista Tuote
